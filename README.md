# thai-financial-holiday

[![npm version](https://img.shields.io/npm/v/thai-financial-holiday.svg)](https://www.npmjs.com/package/thai-financial-holiday)
...
```bash
# npm
npm install thai-financial-holiday

# pnpm
pnpm add thai-financial-holiday

# yarn
yarn add thai-financial-holiday
```
...
```typescript
import { isHoliday } from 'thai-financial-holiday';
...
```typescript
import { getHolidays } from 'thai-financial-holiday';
...
```typescript
import { getNextHoliday } from 'thai-financial-holiday';
...
```typescript
import { getHolidaysInRange } from 'thai-financial-holiday';
...
```typescript
import { getHoliday } from 'thai-financial-holiday';
...
```typescript
import { isBusinessDay, addBusinessDays, getBusinessDaysInRange } from 'thai-financial-holiday';
